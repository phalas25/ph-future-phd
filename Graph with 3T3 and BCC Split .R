...
qPCR_DCAA_2$Sample.Name <- factor(WT$Sample.Name, levels = c("3T3 SS 0 mM DCAA", "3T3 SS 80 mM  DCAA", "3T3 SS 100 mM DCAA", "3T3 SS 126 mM DCAA", "3T3 SS 160 mM DCAA", "3T3 SSH 0 mM DCAA", "3T3 SSH 80 mM DCAA", "3T3 SSH 100 mM DCAA", "3T3 SSH 126 mM DCAA", "3T3 SSH 160 mM DCAA"))
print(qPCR_DCAA_2)
...
Plot <- Plot + ggtitle("GLI1 Expression") +
  xlab("Concentration Dichloroacetic Acid") + ylab("Fold Change") + theme_classic() + labs(fill = "Sample Name") + theme(axis.text.x = element_text(size=10, angle=90),axis.title=element_text(size=12,face="bold")) 
print(Plot)
...
Plot <- Plot + theme_classic() + ggtitle("WT GLI1 Expression with PDHK Inhibitor") + theme(plot.title = element_text(hjust = 0.5)) +
